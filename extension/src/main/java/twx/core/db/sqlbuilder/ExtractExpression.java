...
public class ExtractExpression extends Expression
{
   ...
   * extensions module.
   * 
   * @see twx.core.db.sqlbuilder.custom.postgresql.PgExtractDatePart
   * @see twx.core.db.sqlbuilder.custom.mysql.MysExtractDatePart
   * @see twx.core.db.sqlbuilder.custom.oracle.OraExtractDatePart
   */
