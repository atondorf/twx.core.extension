...
package twx.core.db.sqlbuilder.dbspec.basic;

import java.util.ArrayList;
import java.util.List;

import twx.core.db.sqlbuilder.Condition;
import twx.core.db.sqlbuilder.dbspec.Constraint;
import twx.core.db.sqlbuilder.dbspec.RejoinTable;
...
public class DbTable extends DbObject<DbSchema> implements Table {
  ...
  public DbColumn addColumn(String name, String typeName, Integer typePrecision, Integer typeScale) {
    DbColumn column = getSpec().createColumn(this, name, typeName, typePrecision, typeScale);
  ...
  public DbColumn addColumn(String name, int type, Integer typePrecision, Integer typeScale) {
    return addColumn(name, DbColumn.getTypeName(type), typePrecision, typeScale);
  }
  ...
  public DbConstraint unique(String name, String... colNames) {
    DbConstraint constraint = getSpec().createTableConstraint( this, name, Constraint.Type.UNIQUE, colNames );
  ...
  public DbForeignKeyConstraint foreignKey(String name, DbColumn[] columns,
      ...
      DbColumn[] refColumns) {
    DbForeignKeyConstraint fkConstraint = getSpec().createTableForeignKeyConstraint(
