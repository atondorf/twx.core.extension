...
package twx.core.db.sqlbuilder;

import twx.core.db.sqlbuilder.dbspec.Column;
import twx.core.db.sqlbuilder.dbspec.Constraint;
import twx.core.db.sqlbuilder.dbspec.Function;
import twx.core.db.sqlbuilder.dbspec.Index;
import twx.core.db.sqlbuilder.dbspec.Table;
...
public abstract class Converter<SrcType, DstType>
{
   ...
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Column} -&gt; {@link ColumnObject}</li>
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Table} -&gt; {@link TableObject}</li>
   * </ul>
   *
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Constraint} -&gt; {@link ConstraintObject}</li>
   * </ul>
   *
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Table} -&gt; {@link TableDefObject}</li>
   * </ul>
   *
   * @param table object to coerce to a table SqlObject
   * @return a SqlObject for the given Table
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Index} -&gt; {@link IndexObject}</li>
   * </ul>
   *
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Function} -&gt; {@link FunctionObject}</li>
   * </ul>
   *
   ...
   * Conversions (in order):
   * <ul>
   * <li>{@link twx.core.db.sqlbuilder.dbspec.Column} -&gt; {@link TypedColumnObject}</li>
   * <li>{@code null} -&gt; {@link SqlObject#NULL_VALUE}</li>
   * <li>{@link SqlObject} -&gt; {@link SqlObject}</li>
   * <li>{@link java.lang.Boolean} -&gt; {@link BooleanValueObject}</li>
   * <li>{@link java.lang.Number} -&gt; {@link NumberValueObject}</li>
