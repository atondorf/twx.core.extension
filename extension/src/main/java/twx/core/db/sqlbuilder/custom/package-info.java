 ...
 *     {@link twx.core.db.sqlbuilder.CustomSql}, {@link
 *     twx.core.db.sqlbuilder.CustomExpression}, and {@link
 *     twx.core.db.sqlbuilder.CustomCondition}.</li>
 ...
 *     syntax support (e.g. {@link twx.core.db.sqlbuilder.SelectQuery}).  This is done via a
 *     nested {@code Hook} enum which defines the "hook anchors" for that type
 *     (e.g. {@link twx.core.db.sqlbuilder.SelectQuery.Hook}).</li>
 * <li>A "hook anchor" (an enum which implements the {@link
 *     twx.core.db.sqlbuilder.custom.HookAnchor} marker interface)
 ...
 * <li>The {@link twx.core.db.sqlbuilder.custom.HookType} is the
 ...
 *     syntax implementation may extend {@link twx.core.db.sqlbuilder.custom.CustomSyntax}, but that is
 ...
 *     addCustomization()} method (e.g. {@link twx.core.db.sqlbuilder.SelectQuery#addCustomization(CustomSyntax)}).
 *     However, any ad hoc custom syntax can be added to customizable queries
 *     by specifying the HookType and "hook anchor" when adding (e.g. {@link twx.core.db.sqlbuilder.SelectQuery#addCustomization(Hook,HookType,Object)})</li>
 * </ul>
 *
 ...
 * <ul>
 * <li>Oracle {@link twx.core.db.sqlbuilder.custom.oracle}</li>
 * <li>MySQL {@link twx.core.db.sqlbuilder.custom.mysql}</li>
 * <li>PostreSQL {@link twx.core.db.sqlbuilder.custom.postgresql}</li>
 * <li>SQL Server {@link twx.core.db.sqlbuilder.custom.sqlserver}</li>
 * </ul>
 *
 ...
 * <ul>
 * <li>{@link twx.core.db.sqlbuilder.SelectQuery}</li>
 * <li>{@link twx.core.db.sqlbuilder.CreateTableQuery}</li>
 * <li>{@link twx.core.db.sqlbuilder.CreateIndexQuery}</li>
 * </ul>
 */
package twx.core.db.sqlbuilder.custom;
